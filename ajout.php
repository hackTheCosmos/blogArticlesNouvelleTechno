<?php
session_start();
//protection de la route, si on est pas connecté et qu'on a pas le role admin, on ne peut pas accéder à la page ajout
if(!isset($_SESSION['user']) || $_SESSION['user']['roles'] !== '["ROLE_USER", "ROLE_ADMIN"]') {
